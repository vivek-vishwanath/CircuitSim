...
public class RandomGeneratorPeer extends ComponentPeer<RandomGenerator> {
	...
	public RandomGeneratorPeer(Properties props, int x, int y) {
		...
		connections.add(
			clockConnection =
				new PortConnection(this, randomGenerator.getPort(RandomGenerator.Ports.PORT_CLK), "Clock", 2, 4));
		connections.add(new PortConnection(this, randomGenerator.getPort(Negator.Ports.PORT_OUT), "Out", 4, 2));
