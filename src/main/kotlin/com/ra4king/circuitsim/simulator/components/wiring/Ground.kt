...
import com.ra4king.circuitsim.simulator.components.wiring.Ground.Ports.PORT

/**
 * @author Austin Adams and Roi Atalla
 */
class Ground(name: String) : Component(name, intArrayOf(1)) {
    override fun init(circuitState: CircuitState, lastProperty: Any?) {
        circuitState.pushValue(getPort(PORT), WireValue(WireValue.State.ZERO))
    }
