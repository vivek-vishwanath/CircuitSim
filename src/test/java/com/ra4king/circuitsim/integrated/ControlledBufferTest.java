...
public class ControlledBufferTest {
	...
	public void testControlledBuffer() {
		...
		inA.getPort(Pin.Ports.PORT).linkPort(andGate.getPort(0)).linkPort(orGate.getPort(0)).linkPort(xorGate.getPort(0));
		inB.getPort(Pin.Ports.PORT).linkPort(andGate.getPort(1)).linkPort(orGate.getPort(1)).linkPort(xorGate.getPort(1));
		bufferA.getPort(ControlledBuffer.Ports.PORT_IN).linkPort(andGate.getOutPort());
		bufferA.getPort(ControlledBuffer.Ports.PORT_ENABLE).linkPort(selA.getPort(Pin.Ports.PORT));
		bufferA.getPort(ControlledBuffer.Ports.PORT_OUT).linkPort(out.getPort(Pin.Ports.PORT));
		
		bufferB.getPort(ControlledBuffer.Ports.PORT_IN).linkPort(orGate.getOutPort());
		bufferB.getPort(ControlledBuffer.Ports.PORT_ENABLE).linkPort(selB.getPort(Pin.Ports.PORT));
		bufferB.getPort(ControlledBuffer.Ports.PORT_OUT).linkPort(out.getPort(Pin.Ports.PORT));
		
		bufferC.getPort(ControlledBuffer.Ports.PORT_IN).linkPort(xorGate.getOutPort());
		bufferC.getPort(ControlledBuffer.Ports.PORT_ENABLE).linkPort(selC.getPort(Pin.Ports.PORT));
		bufferC.getPort(ControlledBuffer.Ports.PORT_OUT).linkPort(out.getPort(Pin.Ports.PORT));
