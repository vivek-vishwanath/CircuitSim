...
public class GatesTest {
	...
	public void testAndGate() {
		...
		andGate.getPort(0).linkPort(in1.getPort(Pin.Ports.PORT));
		andGate.getPort(1).linkPort(in2.getPort(Pin.Ports.PORT));
		andGate.getOutPort().linkPort(out.getPort(Pin.Ports.PORT));
